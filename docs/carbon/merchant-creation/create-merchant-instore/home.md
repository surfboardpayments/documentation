...
{% pills tabs=[
  {
    label: "Using API",
    markdocSrc: "carbon/merchant-creation/create-merchant-instore/create-merchant-api.md"
  },
  {
    label: "Using Partner Portal",
    markdocSrc: "carbon/merchant-creation/create-merchant-instore/create-merchant-partner-portal.md"
  }
] /%}
