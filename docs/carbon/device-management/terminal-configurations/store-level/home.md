...
{% pills tabs=[
  {
    label: "Using API",
    markdocSrc: "carbon/device-management/terminal-configurations/store-level/api.md"
  },
  {
    label: "Using Partner Portal",
    markdocSrc: "carbon/device-management/terminal-configurations/store-level/partner-portal.md"
  }
] /%}
