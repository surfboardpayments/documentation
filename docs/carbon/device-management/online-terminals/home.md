...
{% pills tabs=[
  {
    label: "Using API",
    markdocSrc: "carbon/device-management/online-terminals/api.md"
  },
  {
    label: "Using Partner Portal",
    markdocSrc: "carbon/device-management/online-terminals/partner-portal.md"
  },
  {
    label: "Using Merchant Portal",
    markdocSrc: "carbon/device-management/online-terminals/merchant-portal.md"
  }
] /%}
