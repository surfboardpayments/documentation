---
title: "Configure Branding Using API"
description: "Guide to configure branding for payment terminals in-store using API."
category: "In-Store Payment Guides"
path: "/guides/in-store-payments/administration/configure-branding/api-tab.md"
---

Branding can be configured at various levels using following APIs

- [**Create branding for merchant API**](/api/branding#Create-Branding-for-Merchant)
- [**Create branding for store API**](/api/branding#Create-Branding-for-Store)
- [**Create branding for partner API**](/api/branding#Create-Branding-for-Partner)
...
2. The API returns a **`message`** in the response confirming the branding is configured at specified levels.