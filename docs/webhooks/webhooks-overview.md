...
{% docfooter relatedLinks="[{ title: 'APIs and Environments', url: '/guides/in-store-payments/integrations/apis-and-environments' },{ title: 'API Architecture', url: '/guides/in-store-payments/integrations/api-architecture' },{ title: 'Environments', url: '/guides/in-store-payments/integrations/environments' }]" /%}
