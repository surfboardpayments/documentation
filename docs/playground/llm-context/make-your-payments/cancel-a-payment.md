<!-- 
  ...
  Version: 1.0.0
  Generated at: 2025-12-20T10:26:55.156Z
  
  This file is auto-generated. Do not edit manually.
-->

# API Integration Context: Cancel a Payment

> This document provides comprehensive context for integrating with our API.
> Use this with an LLM to get help implementing the Cancel a Payment flow.
...
1. **Cancel a Payment** - To cancel a payment after the payment is initiated
2. **Check Order Status** - Check the status of the order

---

## Step 1: Cancel a Payment
...
To cancel a payment after the payment is initiated
...
| `data.paymentStatus` | string | Describes the status of the payment. The possible values are: Possible values: `PAYMENT_COMPLETED`, `PAYMENT_FAILED`, `PAYMENT_CANCELLED` |
...
|------|--------|----------|---------|
| 1 | DELETE | `payments/{{paymentId}}` | To cancel a payment after the payment is initiated |
