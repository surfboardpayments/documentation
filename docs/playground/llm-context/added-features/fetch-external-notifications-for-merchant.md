...
# API Integration Context: Fetch External Notifications for Merchant

> This document provides comprehensive context for integrating with our API.
> Use this with an LLM to get help implementing the Fetch External Notifications for Merchant flow.

## Overview

**Category:** Added Features
**Scenario:** Fetch External Notifications for Merchant
**Description:** Fetch External Notifications for Merchant
...
1. **Fetch External Notifications for Merchant** - Fetch External Notifications for Merchant

---

## Step 1: Fetch External Notifications for Merchant
...
|------|--------|----------|---------|
| 1 | GET | `merchants/{{merchantId}}/notifications` | Fetch External Notifications for Merchant |
