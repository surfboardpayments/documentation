...
# API Integration Context: Fetch Service Provider for Merchant

> This document provides comprehensive context for integrating with our API.
> Use this with an LLM to get help implementing the Fetch Service Provider for Merchant flow.

## Overview

**Category:** Added Features
**Scenario:** Fetch Service Provider for Merchant
**Description:** Fetch Service Provider for Merchant
...
1. **Fetch Service Provider For Merchant** - Fetch Service Provider For Merchant

---

## Step 1: Fetch Service Provider For Merchant
...
This API allows merchants to retrieve all service providers linked to their merchant account, helping them view and manage the service providers involved in their transactions and revenue distribution.
...
|------|--------|----------|---------|
| 1 | GET | `merchants/{{merchantId}}/service-providers` | Fetch Service Provider For Merchant |
